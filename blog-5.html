...
<head>
   <title>Hari ke Tigapuluh Prakerin di Duxeos Software House</title>
    	...
    	<div id="mainContent">
            <div id="content">
	           <article id="article" class="card article">
	               <h2 class="center">Hari ke Tigapuluh Prakerin di Duxeos Software House</h2>
	               <div class="featured-image imageBlog">
	                      <img src="assets/upload/bakar.jpg" alt="Hari ke Tigapuluh Prakerin di Duxeos Software House">
	                   </div>
	               <div class="text">
		               <p>Pada hari ketigapuluh saya dan kawan-kawan prakerin di duxeos.com kami melaksanakan bakar-bakar yang sudah kami diskusikan dulu. Pada hari itu kami melakukan banyak hal seperti membakar jagung, kemudian membakar sosis dan lain sebagainya.</p>
	               </div>
	           </article>
	       </div>
	    </div>
